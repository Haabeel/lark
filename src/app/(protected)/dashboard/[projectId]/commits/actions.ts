...
If the context does not provide the answer to question, the AI assistant will say "I don't know the answer to that question".
...
Answer in markdown syntax, with code snippets if needed. Be as detailed as possible when answering,
    make sure there is no repetition in the answer.`,
    });
